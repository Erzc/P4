...
namespace P4_DepreciationForm
{
    ...
    class DepreciationDoubleDeclining : DepreciationStraightLine
    {
        ...
        //The ToString for DepreciationDoubleDeclining should return the same text as StrightLine but also add the fact that this
        //item uses double declining depreciation.
